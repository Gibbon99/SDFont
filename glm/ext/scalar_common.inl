namespace glm
{
	template<typename T> GLM_FUNC_QUALIFIER T
	min(T
	a,
	T b, T
	c)
...
// fclamp
template<typename genType> GLM_FUNC_QUALIFIER genType
fclamp(genType
x,
...
return
glm::clamp(Texcoord,
static_cast<genType>(0), static_cast<genType>(1));
}
...
return
mix(Rest,
static_cast<genType>(1) - Rest, Mirror >= static_cast<genType>(1));
}
...
template<typename genType> GLM_FUNC_QUALIFIER uint
uround(genType
const& x)
{
GLM_STATIC_ASSERT(std::numeric_limits<genType>::is_iec559,
